        ...
        ************   Navigation / Router   ************
        ...
        app.router = {
            ...
            animatePages: function (leftPage, rightPage, direction, view) {
                ...
                if (direction === 'to-left') {
                    leftPage.removeClass(removeClasses).addClass('pt-page-moveToBottomEasing pt-page-ontop');
                    rightPage.removeClass(removeClasses).addClass('pt-page-moveFromTop');
                }
                // Go back
        ...
        app.router._load = function (view, options) {
            ...
            function afterAnimation() {
                view.allowPageChange = true;
                newPage.removeClass('pt-page-moveFromTop').addClass('page-on-center');
                oldPage.removeClass('pt-page-moveToBottomEasing pt-page-ontop').addClass('page-on-left');
                if (dynamicNavbar) {
